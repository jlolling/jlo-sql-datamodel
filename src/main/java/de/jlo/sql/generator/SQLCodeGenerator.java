...
import de.jlo.sql.ext.DatabaseExtension;
import de.jlo.sql.model.BasicDataType;
import de.jlo.sql.model.ModelComparator;
import de.jlo.sql.model.SQLConstraint;
import de.jlo.sql.model.SQLDataModel;
import de.jlo.sql.model.SQLField;
import de.jlo.sql.model.SQLFieldNotNullConstraint;
import de.jlo.sql.model.SQLIndex;
import de.jlo.sql.model.SQLObject;
import de.jlo.sql.model.SQLPSParam;
import de.jlo.sql.model.SQLProcedure;
import de.jlo.sql.model.SQLProcedure.Parameter;
import de.jlo.sql.model.SQLSchema;
import de.jlo.sql.model.SQLSequence;
import de.jlo.sql.model.SQLStatement;
        ...
        if (table != null) {
        	...
        	if (table.isTable() || viewAsTable) {
                ...
                if (table.getFieldCount() > 0) {
                    ...
                    sb.append(");\n");
                    DatabaseExtension ext = table.getModel().getDatabaseExtension();
                    String tableCommentStat = ext.getUpdateCommentStatement(tableName, table.getComment());
                    if (tableCommentStat != null && tableCommentStat.trim().isEmpty() == false) {
                    	sb.append("\n");
                    ...
                    for (int i = 0; i < table.getFieldCount(); i++) {
                    	...
                    	if (columnComment != null && columnComment.trim().isEmpty() == false) {
